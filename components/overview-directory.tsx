...
export default function OverviewDirectory({ onNavigate }: { onNavigate: (view: string) => void }) {
  const tiles = [
    ...
    { view: "responsibility", title: "Zodpovednosť", text: "Kto a ako dlho vládol od roku 1993" },
    ...
    { view: "game", title: "Herňa", text: "Denná väčšina, Do decembra a Malá republika — tri hry" },
