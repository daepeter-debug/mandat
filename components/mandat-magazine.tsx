...
export function MandatMagazine({poll,onAgency,onNavigate,parliament,onParliament,onOpenNews}:{poll:Poll;onAgency:(a:string)=>void;onNavigate:(v:string)=>void;parliament:string;onParliament:(v:string)=>void;onOpenNews:(id:string)=>void}) {
  ...
  return <div className="magazine">
    <NationalIntro onNavigate={onNavigate} parliament={parliament} onParliament={onParliament} onOpenNews={onOpenNews}/>
