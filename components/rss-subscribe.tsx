...
export default function RssSubscribe() {
  ...
  return <details className="rss-box">
    ...
    <div className="rss-actions">
      ...
      <button type="button" onClick={() => window.open(`https://feedly.com/i/subscription/feed/${encodeURIComponent(feedUrl())}`, "_blank", "noopener,noreferrer")}>Otvoriť vo Feedly<ExternalLink size={15} aria-hidden="true"/></button>
