...
export default function ProgrammeLibrary() {
  ...
  return <>
    <section className="intro programme-hero"><div><h1>Čo platilo vtedy.<br/><em>Čo navrhujú dnes.</em></h1><p className="intro-description">Oddelený archív volieb 2023, priebežne overované nové návrhy a porovnanie konkrétnych tém bez predstierania, že každá strana už má hotový program 2027.</p></div><div className="programme-legend"><span><i className="current"/>Aktuálne návrhy</span><span><i className="archive"/>Archív 2023</span><p>Žiadny dokument tu neoznačíme ako program 2027, kým ho tak neoznačí samotná strana.</p></div></section>
    <ProgrammeMatrix/>
