...
const KEEP_SELECTOR = /-logo(?![\w-])|resp-mark|person-portrait|monogram|party-logo-sources a (img|svg)|section-art img|slovakia-mark|theme-switch|games-republic-art|games-town|games-parliament/;
