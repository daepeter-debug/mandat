...
export type Cabinet = {
  ...
  parties: string;     // koaličné strany v čase vymenovania
  color: string;
  note?: string;
};
...
export const cabinets: Cabinet[] = [
  { id: 'meciar2', name: 'Druhá vláda Vladimíra Mečiara', short: 'Mečiar II', pm: 'Vladimír Mečiar', start: '1993-01-01', end: '1994-03-15', parties: 'HZDS, SNS', color: '#5b6b8c', note: 'Vymenovaná 24. 6. 1992, počítame od vzniku samostatnej SR.' },
  { id: 'moravcik', name: 'Vláda Jozefa Moravčíka', short: 'Moravčík', pm: 'Jozef Moravčík', start: '1994-03-15', end: '1994-12-13', parties: 'DÚ, SDĽ, KDH, NDS', color: '#8a8f99' },
  { id: 'meciar3', name: 'Tretia vláda Vladimíra Mečiara', short: 'Mečiar III', pm: 'Vladimír Mečiar', start: '1994-12-13', end: '1998-10-30', parties: 'HZDS, SNS, ZRS', color: '#46587d' },
  { id: 'dzurinda1', name: 'Prvá vláda Mikuláša Dzurindu', short: 'Dzurinda I', pm: 'Mikuláš Dzurinda', start: '1998-10-30', end: '2002-10-16', parties: 'SDK, SDĽ, SMK, SOP', color: '#2f6db5' },
  { id: 'dzurinda2', name: 'Druhá vláda Mikuláša Dzurindu', short: 'Dzurinda II', pm: 'Mikuláš Dzurinda', start: '2002-10-16', end: '2006-07-04', parties: 'SDKÚ, SMK, KDH, ANO', color: '#5b8fd1' },
  { id: 'fico1', name: 'Prvá vláda Roberta Fica', short: 'Fico I', pm: 'Robert Fico', start: '2006-07-04', end: '2010-07-09', parties: 'SMER–SD, SNS, ĽS–HZDS', color: '#b83d36' },
  { id: 'radicova', name: 'Vláda Ivety Radičovej', short: 'Radičová', pm: 'Iveta Radičová', start: '2010-07-09', end: '2012-04-04', parties: 'SDKÚ–DS, SaS, KDH, Most–Híd', color: '#4a9fd6' },
  { id: 'fico2', name: 'Druhá vláda Roberta Fica', short: 'Fico II', pm: 'Robert Fico', start: '2012-04-04', end: '2016-03-23', parties: 'SMER–SD', color: '#c9534b' },
  { id: 'fico3', name: 'Tretia vláda Roberta Fica', short: 'Fico III', pm: 'Robert Fico', start: '2016-03-23', end: '2018-03-22', parties: 'SMER–SD, SNS, Most–Híd, Sieť', color: '#d66c64' },
  { id: 'pellegrini', name: 'Vláda Petra Pellegriniho', short: 'Pellegrini', pm: 'Peter Pellegrini', start: '2018-03-22', end: '2020-03-21', parties: 'SMER–SD, SNS, Most–Híd', color: '#e0867f' },
  { id: 'matovic', name: 'Vláda Igora Matoviča', short: 'Matovič', pm: 'Igor Matovič', start: '2020-03-21', end: '2021-04-01', parties: 'OĽANO, SME RODINA, SaS, ZA ĽUDÍ', color: '#c9a227' },
  { id: 'heger', name: 'Vláda Eduarda Hegera', short: 'Heger', pm: 'Eduard Heger', start: '2021-04-01', end: '2023-05-15', parties: 'OĽANO, SME RODINA, SaS, ZA ĽUDÍ', color: '#8fae4a', note: 'Od decembra 2022 po vyslovení nedôvery dočasne poverená vláda.' },
  { id: 'odor', name: 'Vláda Ľudovíta Ódora', short: 'Ódor', pm: 'Ľudovít Ódor', start: '2023-05-15', end: '2023-10-25', parties: 'úradnícka vláda', color: '#7a7f8a' },
  { id: 'fico4', name: 'Štvrtá vláda Roberta Fica', short: 'Fico IV', pm: 'Robert Fico', start: '2023-10-25', end: null, parties: 'SMER–SD, HLAS–SD, SNS', color: '#a3302a' },
];
