    ...
    <Tabs value={view} onValueChange={changeView} activationMode="manual" className="page-tabs">
      ...
      <main id="main">
        ...
        <TabsContent value="polls">
          <section className="intro polls-intro"><div><h1>Archív meraní</h1><p className="intro-description">Kto sa pýtal, kedy a koho. Výsledky spolu s metodikou a pôvodným zdrojom.</p></div></section>
